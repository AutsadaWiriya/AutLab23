...
LRESULT CALLBACK WndProc(HWND hwnd, UINT Message, WPARAM wParam, LPARAM lParam) {
	switch(Message) {
			case WM_CREATE: 
				...
				Button = CreateWindow("BUTTON","+",WS_VISIBLE|WS_CHILD|WS_BORDER,64,120,25,25,hwnd,(HMENU) 1,NULL,NULL);
				Button = CreateWindow("BUTTON","-",WS_VISIBLE|WS_CHILD|WS_BORDER,94,120,25,25,hwnd,(HMENU) 2,NULL,NULL);
				Button = CreateWindow("BUTTON","*",WS_VISIBLE|WS_CHILD|WS_BORDER,124,120,25,25,hwnd,(HMENU) 3,NULL,NULL);
				Button = CreateWindow("BUTTON","/",WS_VISIBLE|WS_CHILD|WS_BORDER,154,120,25,25,hwnd,(HMENU) 4,NULL,NULL);
				break;
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nCmdShow) {
	...
	HBRUSH hbrush;
  hbrush = CreateSolidBrush(RGB(50, 219, 191));
